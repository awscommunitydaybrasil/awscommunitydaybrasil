      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href={`mailto:${config.contact.email}`} className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                <Mail size={16} className="shrink-0" />
                {config.contact.email}
              </a>
            </li>
            <li>
              <a href={config.contact.website} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                <Globe size={16} className="shrink-0" />
                {config.contact.website.replace("https://www.", "")}
              </a>
            </li>
          </ul>
        </div>
