...
const HeroSection = () => {
  return (
    <section className="relative min-h-[75vh] flex items-center justify-center overflow-hidden pt-16"
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-0 animate-[fade-in_1.5s_ease-out_0.3s_forwards]">
        <div className="w-[600px] h-[600px]">
          <BrazilMapSVG />
        </div>
      </div>
      <div className="relative z-10 text-center container">
        <p className="text-sm font-semibold tracking-[0.3em] uppercase text-primary mb-4 font-display opacity-0 animate-[fade-in_0.8s_ease-out_0.2s_forwards]">
          2026
        </p>
        <img src={logo} alt="AWS Community Day Brasil" className="max-w-md md:max-w-xl lg:max-w-3xl mx-auto mb-6 opacity-0 animate-[fade-in_0.8s_ease-out_0.5s_forwards]" />
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 font-body opacity-0 animate-[fade-in_0.8s_ease-out_0.8s_forwards]">
          O maior movimento de comunidades AWS do Brasil
        </p>
        <a
          href="#regioes"
          className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-primary text-primary-foreground font-display font-bold text-sm uppercase tracking-wider hover:brightness-110 transition-all animate-pulse-glow opacity-0 animate-[fade-in_0.8s_ease-out_1.1s_forwards]"
        >
          Explorar regiões
